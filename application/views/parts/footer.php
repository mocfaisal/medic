...
<div class=" container-fluid  container-fixed-lg footer">
  <div class="copyright sm-text-center">
    <p class="small no-margin pull-left sm-pull-reset">
      ...
      <span class="font-montserrat">Mocfaisal</span>.
...
<script src="<?php echo base_url('assets'); ?>/plugins/jquery-datatable/media/js/jquery.dataTables.js" type="text/javascript"></script>
...
// prevent firing twice request ajax
